...
class Order extends Generic{
    ...
    public function getProductCount(){
        $res = parent::getConnection()->prepare(
            "select o.idProduct as idProduct,count(o.idOrder) as pQuantity, p.name as name FROM orderproduct o, product p WHERE o.idProduct = p.ID GROUP BY idProduct ORDER BY idProduct DESC LIMIT 5"
        );
        $res->execute();
        return $res->fetchAll();
    }
